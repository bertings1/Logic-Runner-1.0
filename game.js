(() => {
  ...
  function focusGamePanel(on = true) {
    if (on) { hero.classList.add('focus-hide'); gameArea.classList.add('focused'); }
    else { hero.classList.remove('focus-hide'); gameArea.classList.remove('focused'); }
  }
  ...
  function openTutorialModal() { closeModal(); const modal = document.createElement('div'); modal.className = 'modal-overlay'; modal.innerHTML = `<div class="modal-popup">
      ...
      <ol style="margin-top:10px">
        ...
        <li>Questions include match, logic, and multi-type truth tables.</li>
      </ol>
